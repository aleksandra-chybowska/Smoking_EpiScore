...
--data-file /Cluster_Filespace/Marioni_Group/Ola/Smoking/BayesRR/data/multiomics_W1_W3/pack_years_W3_W4_allchrom_processed.csv \
--pheno /Cluster_Filespace/Marioni_Group/Ola/Smoking/BayesRR/data/pack_years_wave1_wave3_genetic_age_sex_9316_not_residualized.csvphen \
--group /Cluster_Filespace/Marioni_Group/Ola/Smoking/BayesRR/data/multiomics_W1_W3/pack_years_cpg_groups.txt \
