...
# saveRDS(lbc_mvals, '/Cluster_Filespace/Marioni_Group/Ola/Smoking/Elnet_EpiScore/data/lbc_mvals_EpiScore_testing.RDS')
lbc_mvals <- t(lbc_mvals)
...
write.csv(result, "/Cluster_Filespace/Marioni_Group/Ola/Smoking/BayesR_EpiScore/data/sensitivity/EpiSmokEr.csv")