...
pass5_40 = readRDS("<cluster_home_dir>/ONT/methrix/5_40_raw_no_snps.RDS")
...
saveRDS(df_dm_annotated, '<cluster_home_dir>/ONT/methrix/5_40_CpGs_annotated.RDS', compress=F)
ds = readRDS('<cluster_home_dir>/ONT/methrix/5_40_CpGs_annotated.RDS')

annots = df_dm_annotated
annots = ds
ewas = read.csv("<cluster_home_dir>/ONT/EWAS/5_40_46_full_EWAS_ONT.csv")
head(ewas)
...
write.csv(ont_annots, "<cluster_home_dir>/ONT/EWAS/5_40_46_significant_annotated_fully.csv")
...
write.csv(cleaned_data, '<cluster_home_dir>/ONT/EWAS/40_5_46_annotated_hits_cleaned_data.csv', row.names=F)
...
write.table(only_genes_from_annots, '<cluster_home_dir>/ONT/EWAS/5_40_46_annots_only_genes.csv', 
  row.names = F, col.names = F, quote = FALSE, sep=",")
saveRDS(annots, '<cluster_home_dir>/ONT/EWAS/5_40_46_annots.RDS', compress = F)
...
write.table(only_genes_from_annots_significant, '<cluster_home_dir>/ONT/EWAS/5_40_46_annots_only_genes_significant.csv', 
  row.names = F, col.names = F, quote = FALSE, sep=",")
write.csv(df, '<cluster_home_dir>/ONT/EWAS/5_40_46_annotated_hits.csv', row.names=F)
...
write.table(only_genes_from_annots_significant_split, 
  '<cluster_home_dir>/ONT/EWAS/5_40_46_CpGs_annotated_min_only_genes_significant_split.csv', 
  row.names = F, col.names = F, quote = FALSE, sep=",")
