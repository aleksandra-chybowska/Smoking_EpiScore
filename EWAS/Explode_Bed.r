...
saveRDS(bed, '<cluster_home_dir>/TWIST/bed_new_id.RDS')
...
saveRDS(blended, '<cluster_home_dir>/TWIST/bed_exploded.RDS')
...
setwd("<datastore_home_dir>/Lab/Smoking/TWIST/annotations/")
...
hits_only = readRDS('<datastore_home_dir>/Lab/Smoking/twist_vs_EPIC/Manual_EWAS/40_10_EWAS.RDS')
...
w3 = read.csv("<datastore_home_dir>/Lab/Smoking/twist_vs_EPIC/W3_processed.csv")
