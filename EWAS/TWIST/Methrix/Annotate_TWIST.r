...
ewas = read.csv('/Cluster_Filespace/Marioni_Group/Ola/TWIST/Manual_EWAS/pass10_40_46_full_EWAS_TWIST.csv')
head(ewas)
...
write.csv(df, '/Cluster_Filespace/Marioni_Group/Ola/TWIST/Annotations/40_10_46_annotated_hits.csv', row.names=F)
...
write.csv(cleaned_data, '/Cluster_Filespace/Marioni_Group/Ola/TWIST/Annotations/40_10_46_annotated_hits_cleaned_data.csv', row.names=F)
...
write.table(only_genes_from_annots, 
  '/Cluster_Filespace/Marioni_Group/Ola/TWIST/Annotations/40_10_46samples_CpGs_annotated_min_only_genes.csv', 
...
write.table(only_genes_from_annots_significant, 
  '/Cluster_Filespace/Marioni_Group/Ola/TWIST/Annotations/40_10_CpGs_annotated_min_only_genes_significant.csv', 
  row.names = F, col.names = F, quote = FALSE, sep=",")
...
write.table(only_genes_from_annots_significant_split, 
  '/Cluster_Filespace/Marioni_Group/Ola/TWIST/Annotations/40_10_CpGs_annotated_min_only_genes_significant_split.csv', 
  row.names = F, col.names = F, quote = FALSE, sep=",")
...
ewas <- read.csv('/Cluster_Filespace/Marioni_Group/Ola/TWIST/Manual_EWAS/W3_46.csv')

head(ewas)
ewas_significant = subset(ewas, ewas$pval < 1e-5) #44
epic = merge(ewas_significant, anno, by.x = "cpg", by.y = "Name")
write.csv(epic, '/Cluster_Filespace/Marioni_Group/Ola/TWIST/Manual_EWAS/epic/40_10_46_annotated_hits.csv', row.names=F)
